...
# Great work! Notice that the minimum on the plot, that is the value of the
# slope that gives the minimum sum of the square of the residuals, is the same
# value you got when performing the regression.
